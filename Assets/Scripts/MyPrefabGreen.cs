...
public class MyPrefabGreen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 offset1 = new Vector3(12, 0, 10);
        Vector3 offset2 = new Vector3(24, 0, 16);
        Vector3 offset3 = new Vector3(-17, 0, 17);
        Vector3 offset4 = new Vector3(11, 0, -12);
        Vector3 offset5 = new Vector3(-17, 0, -12);
        Vector3 offset6 = new Vector3(-3, 0, 17);
